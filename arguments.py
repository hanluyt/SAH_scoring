...
parser.add_argument('--dataset', type=str, default='sah', metavar='N',
                    help='the dataset used for meta-training (default: sah)')
parser.add_argument('--metric', type=str, default='auc', metavar='N',
                    help='the metric used for evaluate (default: auc)')
...
parser.add_argument('--max_estimators', type=int, default=35, metavar='N',
                    help='maximum number of base estimators in each meta-training episode (default: 35)')
